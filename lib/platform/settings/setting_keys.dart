...
abstract final class SettingKeys {
  ...
  static const notificationsEnabled =
      SettingKey<bool>('notificationsEnabled', true);

  static const defaultReminderMinutes =
      SettingKey<int>('defaultReminderMinutes', 15);
  ...
  static const overdueRepeatHours =
      SettingKey<int>('overdueRepeatHours', 24);
  ...
  static const dndStartMinutes =
      SettingKey<int>('dndStartMinutes', 22 * 60);

  /// DND window end as minutes-since-midnight (default 08:00 = 480).
  static const dndEndMinutes =
      SettingKey<int>('dndEndMinutes', 8 * 60);
}
